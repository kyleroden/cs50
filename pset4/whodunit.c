...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        for (int j = 0; j < bi.biWidth; j++)
        {
            // temporary storage
            RGBTRIPLE triple;
            //RGBTRIPLE describes a color consisting of red, green and blue values.
            //each vlue consumes 8 bits, and takes values in the range between 0-255
            //has values: rgbtRed, rgbtGreen and rgbtBlue
        ...
        // usage: fseek(FILE *, offset, from)
        //FILE* : file to seek over
        //offset: number of bites to move cursor
        //whether we are moving relative to the current position, the beginning or the end of the file
